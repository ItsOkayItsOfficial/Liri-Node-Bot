# liri-node-app
Section 10 - Node Homework

# Hal Bot

### Overview

In this assignment, you will make hal. hal is like iPhone's SIRI. However, while SIRI is a Speech Interpretation and Recognition Interface, hal is a _Language_ Interpretation and Recognition Interface. hal will be a command line node app that takes in parameters and gives you back data.

### Before You Begin

1. hal will display your latest tweets. As we do not want to display your personal account, or its keys, please make an alias account and add a few tweets to it!

2. Make a new GitHub repository called hal-node-app and clone it to your computer.
...
6. Make a JavaScript file named `hal.js`.

7. At the top of the `hal.js` file, write the code you need to grab the data from keys.js. Then store the keys in a variable.

8. Make it so hal.js can take in one of the following commands:
...
1. `node hal.js tweets`

   * This will show your last 20 tweets and when they were created at in your terminal/bash window.

2. `node hal.js song '<song name here>'`
...
3. `node hal.js movie '<movie name here>'`
...
4. `node hal.js hal`
   ...
   * Using the `fs` Node package, hal will take the text inside of random.txt and then use it to call one of hal's commands.

     * It should run `song` for "I Want it That Way," as follows the text in `random.txt`.
